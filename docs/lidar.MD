...
The physical connection is insert the ethernet into the Jetson and supply 24v. The Jetson's onboard Wifi must be disabled for the current configuration to work.
